...
* I, Shreeya Basrur,created a density plot to analyse the distribution of race demographics for mothers in this study. I filled in the density plot yellow for visibility, and added the mean line to clarify the general density plot. I also added axis titles as well as an informative title to be easier to read. This plot was created with the geomdensity function with aesthetic modifiers that filled in the plot yellow and added the dashed line. Geomvline was the function I used to create the mean line for this plot. I also created team plot two in order to answer our second question. 
